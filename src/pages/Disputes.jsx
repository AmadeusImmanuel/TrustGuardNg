...
import { auth, Dispute } from "@/api/base44Client";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-semibold text-[#0D1F3C] text-sm truncate">{d.reason?.substring(0, 60) || "Dispute"}</div>
                      <div className="text-gray-400 text-xs mt-0.5">{new Date(d.created_date).toLocaleDateString("en-NG")}</div>
                    </div>
