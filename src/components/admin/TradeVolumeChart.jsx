...
export default function TradeVolumeChart({ trades }) {
  ...
  return (
    <div className="rounded-2xl border p-6" style={{ background: "#111827", borderColor: "rgba(255,255,255,0.06)" }}>
      <h3 className="font-bold text-white mb-1">Trade Volume (30 days)</h3>
      <p className="text-slate-500 text-xs mb-4">Total escrow value per day</p>
      <ResponsiveContainer width="100%" height={200}>
        <AreaChart data={data}>
          ...
          <Tooltip formatter={(v) => ["₦" + v.toLocaleString("en-NG"), "Volume"]} labelStyle={{ fontSize: 11 }} contentStyle={{ background: "#1A2235", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 10, fontSize: 12, color: "#fff" }} />
